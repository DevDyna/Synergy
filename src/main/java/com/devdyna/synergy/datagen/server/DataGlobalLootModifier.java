...
public class DataGlobalLootModifier extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        DataGenUtil.modifyLootTables(this, DataAnyLoot.GENERIC_MOB_DROPS,
                BuiltInLootTables.ABANDONED_MINESHAFT,
                BuiltInLootTables.SIMPLE_DUNGEON,
        ...
        List<List<ResourceKey<LootTable>>> CHEST_TYPES = List.of(
                ...
                List.of(BuiltInLootTables.ANCIENT_CITY, BuiltInLootTables.END_CITY_TREASURE),
                List.of(BuiltInLootTables.JUNGLE_TEMPLE, BuiltInLootTables.STRONGHOLD_CORRIDOR,
                        BuiltInLootTables.SHIPWRECK_SUPPLY),
                ...
                List.of(BuiltInLootTables.JUNGLE_TEMPLE, BuiltInLootTables.DESERT_PYRAMID),
                List.of(BuiltInLootTables.CAT_MORNING_GIFT, BuiltInLootTables.STRONGHOLD_CORRIDOR,
                        BuiltInLootTables.STRONGHOLD_CROSSING),
                List.of(BuiltInLootTables.NETHER_BRIDGE, BuiltInLootTables.BASTION_BRIDGE,
                        BuiltInLootTables.BASTION_OTHER, BuiltInLootTables.BASTION_TREASURE,
                        BuiltInLootTables.BASTION_HOGLIN_STABLE),
                List.of(BuiltInLootTables.ABANDONED_MINESHAFT, BuiltInLootTables.JUNGLE_TEMPLE));
