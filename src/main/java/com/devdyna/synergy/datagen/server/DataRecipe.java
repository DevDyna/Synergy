...
public class DataRecipe extends ExtraRecipeProvider {
    ...
    protected DataRecipe(RecipeOutput output, Provider p) {
        super(p, output);
    }
    ...
    protected void buildRecipes() {
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.PIPE.get().asItem(), 16)
                .pattern("SSS")
                .pattern("GRG")
                .pattern("SSS")
        ...
        ShapelessRecipeBuilder.shapeless(r, MISC, Items.BLUE_DYE, 4)
                .requires(zItems.BLUE_CUP_MUSHROOM.get())
                .unlockedBy(ID, has(zItems.BLUE_CUP_MUSHROOM.get()))
                .group(zStatic.Plants.BLUE_CUP_MUSHROOM)
                .save(c,
                        x.recipeID(Items.BLUE_DYE, "_from_mushrooms"));

        ShapelessRecipeBuilder.shapeless(r, MISC, Items.BROWN_DYE, 4)
                .requires(zItems.VIOLET_WEBCAP_MUSHROOM.get())
                .unlockedBy(ID, has(zItems.VIOLET_WEBCAP_MUSHROOM.get()))
                .group(zStatic.Plants.VIOLET_WEBCAP_MUSHROOM)
                .save(c,
                        x.recipeID(Items.BROWN_DYE, "_from_mushrooms"));

        ShapelessRecipeBuilder.shapeless(r, MISC, zItems.AZALEA_SEEDS.get(), 3)
                .requires(zItemTag.AZALEA_BUSHES)
                .unlockedBy(ID, has(Items.FLOWERING_AZALEA))
                .group(zStatic.Items.Azalea.seeds).save(c);

        ShapelessRecipeBuilder.shapeless(r, MISC, Items.STRING, 3)
                .requires(zItems.COTTON.get())
                .unlockedBy(ID, has(zItems.COTTON.get()))
                .group(zStatic.Plants.COTTON)
                .save(c,
                        x.recipeID(Items.STRING, "_from_cotton"));

        ShapedRecipeBuilder.shaped(r, MISC, Items.HANGING_ROOTS)
                .pattern("RR")
                .define('R', zItems.SMALL_AZALEA_ROOTS.get())
                .unlockedBy(ID, has(zItems.SMALL_AZALEA_ROOTS.get()))
                .group(zStatic.Items.Azalea.roots)
                .save(c,
                        x.recipeID(Items.HANGING_ROOTS, "_from_small_azalea"));

        ShapedRecipeBuilder.shaped(r, MISC, Items.FLOWERING_AZALEA_LEAVES)
                .pattern("LL")
                .pattern("LL")
                .define('L', zItems.SMALL_AZALEA_LEAF.get())
                .unlockedBy(ID, has(zItems.SMALL_AZALEA_LEAF.get()))
                .group(zStatic.Items.Azalea.leaf)
                .save(c,
                        x.recipeID(Items.FLOWERING_AZALEA_LEAVES, "_from_small_azalea"));

        ShapelessRecipeBuilder.shapeless(r, MISC, Items.FLOWERING_AZALEA)
                .requires(zItems.SMALL_AZALEA_LEAF.get())
                .requires(Items.AZALEA)
                .unlockedBy(ID, has(Items.AZALEA))
                .group(zStatic.Items.Azalea.leaf)
                .save(c,
                        x.recipeID(Items.FLOWERING_AZALEA, "_from_small_azalea"));

        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.SPRINKLER.get())
                .pattern("WWW")
                .pattern("RBR")
                .pattern("AIA")
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Items.IRON_BLOCK), MISC,
                ...
                .group(zStatic.DecorativeBlocks.rustic_metal)
                .save(c,
                        x.recipeID(zBlocks.RUSTIC_METAL.get().asItem(), "_blasting"));

        ShapelessRecipeBuilder.shapeless(r, MISC, zBlocks.WAXED_PLANKS.get(), 8)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.ADOBE.get(), 2)
                .pattern("AAA")
                .pattern("ABA")
                .pattern("AAA")
        ...
        ShapelessRecipeBuilder.shapeless(r, MISC, zItems.ADOBE_BALL.get(), 3)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, Items.SLIME_BALL, 4)
                .pattern(" R ")
                .pattern("RHR")
                .pattern(" R ")
                ...
                .save(c,
                        x.recipeID(Items.SLIME_BALL, "_from_rice"));

        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.SOLAR_PANEL.get())
                .pattern("LLL")
                .pattern("FRF")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.BASIC_MACHINE_FRAME.get())
                .pattern(" C ")
                .pattern("FRF")
                .pattern(" C ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.HARVESTER.get())
                .pattern(" R ")
                .pattern("AMH")
                .pattern(" C ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.COOLER_BASE.get(), 4)
                .pattern("IPI")
                .pattern("P P")
                .pattern("IPI")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.URN.get())
                .pattern("B B")
                .pattern("BHB")
                .pattern("BBB")
        ...
        QuernMillingBuilder.of(r).input(ItemTags.COALS)
        ...
        QuernMillingBuilder.of(r).input(zItems.CREEPER_GALL)
        ...
        QuernMillingBuilder.of(r).input(zItemTag.DUST_URANIUM)
                .output(x.item(zItems.WASTE_FRAGMENT, 3))
        ...
        QuernMillingBuilder.of(r).input(Items.DIAMOND)
        ...
        QuernMillingBuilder.of(r).input(Items.EMERALD)
        ...
        QuernMillingBuilder.of(r).input(Items.AMETHYST_SHARD)
        ...
        QuernMillingBuilder.of(r).input(Items.LAPIS_LAZULI)
        ...
        QuernMillingBuilder.of(r).input(Items.ANCIENT_DEBRIS)
        ...
        QuernMillingBuilder.of(r).input(ItemTags.LOGS)
        ...
        QuernMillingBuilder.of(r).input(Items.QUARTZ)
        ...
        QuernMillingBuilder.of(r).input(Items.PRISMARINE_SHARD)
        ...
        QuernMillingBuilder.of(r).input(Tags.Items.COBBLESTONES)
                .output(Items.GRAVEL)
                .delay(20)
                .unlockedBy().save(c);
        ...
        QuernMillingBuilder.of(r).input(Tags.Items.GRAVELS)
                .output(Items.SAND)
                .delay(20)
                .unlockedBy().save(c);
        ...
        UrnRitualBuilder.of(r).add(Tags.Items.GRAVELS)
                .output(zItems.STONE_PEBBLE, 4)
                .unlockedBy().save(c);

        QuernMillingBuilder.of(r)
        ...
        twoByTwoPacker(c, zItems.CARBON_PLATE.get(), zItems.CARBON_FIBER.get());

        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.QUERN.get())
                .pattern("TS ")
                .pattern("SWS")
        ...
        UrnRitualBuilder.of(r).add(Tags.Items.NETHERRACKS)
                .output(zItems.NETHERRACK_PEBBLE, 4)
                .unlockedBy().save(c);

        UrnRitualBuilder.of(r).add(zItems.INFERNAL_EMBER)
                .add(Items.ENDER_EYE)
                .add(zItemTag.DUST_COAL)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.NETHERRACK_PLATE.get(), 2)
                .pattern(" T ")
                .pattern("TPT")
                .pattern(" T ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.STONE_PLATE.get(), 2)
                .pattern(" T ")
                .pattern("TPT")
                .pattern(" T ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.ADVANCED_MACHINE_FRAME.get())
                .pattern("PCP")
                .pattern("FRF")
                .pattern("PCP")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.MIXED_INGOT.get(), 3)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.LIGHT_BULB.get())
                .define('G', Tags.Items.GLASS_BLOCKS_COLORLESS)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.HEALER.get().asItem())
                .pattern("RWR")
                .pattern("WSW")
                .pattern("RWR")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.REACTOR_CONTROLLER.get().asItem())
                .pattern("PTP")
                .pattern("ACA")
                .pattern("PSP")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.REACTOR_FUEL_CELL.get().asItem(), 2)
                .pattern(" C ")
                .pattern("RPR")
                .pattern(" A ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.WIRED_STONE_PLATE.get())
                .pattern("CPC")
                .pattern(" C ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.STONE_CIRCUIT.get())
                .pattern("PB")
                .pattern("R ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.MAGNETIC_STONE_CIRCUIT.get())
                .pattern("PB")
                .pattern("R ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.RESISTIVE_STONE_CIRCUIT.get())
                .pattern("PB")
                .pattern("R ")
                .define('B', zItemTag.NUGGET_ADVANCEDALLOY)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.SUPERCONDUCTOR.get())
                .pattern("GEG")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.WIRED_NETHER_PLATE.get())
                .pattern("CPC")
                .pattern(" G ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.NETHER_CIRCUIT.get())
                .pattern("CPC")
                .pattern(" G ")
                .define('G', Tags.Items.NUGGETS_GOLD)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, Items.MUD_BRICKS, 1).define('#', zItems.PACKED_MUD_BRICK.get())
        ...
        ShapelessRecipeBuilder.shapeless(r, RecipeCategory.MISC, zItems.PACKED_MUD_BALL.get(), 4)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.CAKE_STICK.get())
                .pattern(" C")
                .pattern("S ")
                .define('C', Items.CAKE)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.INVERTED_REPEATER.get())
                .pattern("RTT")
                .pattern("SSS")
                .define('R', Items.REDSTONE)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.RECURSIVE_REPEATER.get())
                .pattern(" R ")
                .pattern("TET")
                .pattern("SSS")
                .define('E', zItems.ENERGIZED_REDSTONE.get())
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.PULSE_REPEATER.get())
                .pattern(" RT")
                .pattern("TQT")
                .pattern("SSS")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zMachines.MACERATOR.block().get())
                .pattern(" Q ")
                .pattern("RMS")
                .pattern(" C ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zMachines.COMPRESSOR.block().get())
                .pattern(" Q ")
                .pattern("RMS")
                .pattern(" C ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zMachines.ALLOY_SMELTER.block().get())
                .pattern(" Q ")
                .pattern("RMS")
                .pattern(" C ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zMachines.ELECTRIC_FURNACE.block().get())
                .pattern(" Q ")
                .pattern("RMS")
                .pattern(" C ")
                .define('S', zItems.NETHER_CIRCUIT.get())
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.UPGRADE_ENERGY.get())
                .pattern(" B ")
                .pattern("CSC")
                .pattern(" R ")
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zItems.UPGRADE_SPEED.get())
                .pattern(" B ")
                .pattern("CSC")
                .pattern(" R ")
                .define('S', zItemTag.PLATE_STEEL)
        ...
        smeltingResultFromBase(zBlocks.SMOOTH_ADOBE.get(), zBlocks.ADOBE.get());
        ...
        ShapelessRecipeBuilder.shapeless(r, MISC, zItems.FIRECLAY_BALL.get(), 2)
                .requires(zItems.PACKED_MUD_BALL.get())
                .requires(zItemTag.DUST_QUARTZ)
                .unlockedBy(ID, has(zItemTag.DUST_QUARTZ))
                .save(c);

        ShapelessRecipeBuilder.shapeless(r, MISC, zItems.CLAY_MIXTURE_BALL.get(), 3)
                .requires(Items.CLAY_BALL, 2)
                .requires(zItems.FIRECLAY_BALL.get())
                .unlockedBy(ID, has(Items.CLAY_BALL))
                .save(c);

        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.BLAST_BRICKS.get(), 4)
        ...
        ShapedRecipeBuilder.shaped(r, MISC, zBlocks.FIRECLAY_BRICKS.getBricks().get(), 4)
        ...
        ShapelessRecipeBuilder.shapeless(r, MISC, zBlocks.FIRECLAY_BRICK_MOSSY.getBricks().get().asItem())
    ...
    public static final class RecipeRunner extends RecipeProvider.Runner {
        ...
        @Override
        protected net.minecraft.data.recipes.RecipeProvider createRecipeProvider(HolderLookup.Provider lookupProvider,
                RecipeOutput output) {
