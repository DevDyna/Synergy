...
public class Common {
    ...
    private static void automation() {
        ...
        HARVESTER_TREE_CUTTING_LIMIT = number("Max number of harvestable blocks harvestable foreach interaction",
    ...
    protected class coolers {
        ...
        protected static IntValue active(String i, int v) {
            return number(StringUtil.nameCapitalized(i) + " Cooler Active Cooling", i + "_active_cooling", -v,
                    Integer.MIN_VALUE);
        }
    }
    ...
    protected class moderators {
        protected static DoubleValue fe(String i, double v) {
            return numberFloat(StringUtil.nameCapitalized(i) + " Moderator FE Reducer", i + "_fe_reducer", v);
        }

        protected static DoubleValue heat(String i, double v) {
            return numberFloat(StringUtil.nameCapitalized(i) + " Moderator Heat Reducer", i + "_heat_reducer", v);
        }
    }
