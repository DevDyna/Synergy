...
public class PlantMixture extends BoneMealItem {
    ...
    public InteractionResult useOn(UseOnContext c) {
        ...
        if ((block instanceof NetherWartBlock && !Common.DISABLE_PLANT_MIXTURE_ON_NETHER_WART.get())
                || (((block instanceof SugarCaneBlock && !Common.DISABLE_PLANT_MIXTURE_ON_SUGAR_CANES.get())
                        || (block instanceof CactusBlock && !Common.DISABLE_PLANT_MIXTURE_ON_CACTUS.get()))
                        && level.getBlockState(pos.above()).isAir()
                        && !level.getBlockState(pos.below().below()).is(block))
                || (block instanceof VineBlock && !Common.DISABLE_PLANT_MIXTURE_ON_VINES.get())
                || ((block instanceof StemBlock && !Common.DISABLE_PLANT_MIXTURE_ON_STEMS.get())
        ...
        if (Common.DISABLE_PLANT_MIXTURE_VANILLA_FALLBACK.get())
