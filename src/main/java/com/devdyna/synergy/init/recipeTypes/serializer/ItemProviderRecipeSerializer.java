...
public class ItemProviderRecipeSerializer implements RecipeSerializer<ItemProviderRecipe> {

    public static final MapCodec<ItemProviderRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ItemProviderRecipe> STREAM_CODEC = StreamCodec.composite(
    ...
    @Override
    public MapCodec<ItemProviderRecipe> codec() {
        return CODEC;
    }

    @Override
    public StreamCodec<RegistryFriendlyByteBuf, ItemProviderRecipe> streamCodec() {
        return STREAM_CODEC;
    }
