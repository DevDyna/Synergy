...
public class MelterCategory extends BaseMachineRecipeCategory<MelterRecipeType> {
        ...
        public static final RecipeType<RecipeHolder<MelterRecipeType>> TYPE = RecipeType
                        .createFromVanilla(zMachines.MELTER.recipe().getType());

        @Override
        public RecipeType<RecipeHolder<MelterRecipeType>> getRecipeType() {
                return TYPE;
        }
        ...
        @Override
        public void draw(MelterRecipeType recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics,
                        double mouseX,
                        double mouseY) {
